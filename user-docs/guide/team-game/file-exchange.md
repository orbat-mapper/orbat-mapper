# Team-game file exchange reference

For a first practice game, start with [Run a two-team wargame](./index.md).
This reference covers persistent team scenarios, detailed import settings, and
alternative ways to organize the master. Its main example uses force and contact
groups; the tutorial uses separate sides.

This workflow shows how to exchange scenario files during a turn-based game. The
