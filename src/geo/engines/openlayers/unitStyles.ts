...
import {
  selectedUnitStyleCache as neutralSelectedUnitStyleCache,
  unitStyleCache as neutralUnitStyleCache,
  type UnitLabelData,
} from "@/geo/unitStyles";

export type { UnitLabelData };
export { clearUnitStyleCache, invalidateUnitStyle, labelStyleCache } from "@/geo/unitStyles";

export const unitStyleCache = neutralUnitStyleCache as Map<string, Style>;
export const selectedUnitStyleCache = neutralSelectedUnitStyleCache as Map<string, Style>;
