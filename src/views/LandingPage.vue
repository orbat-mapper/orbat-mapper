  ...
  <div class="pb-8">
    <main class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
      ...
      <ProseSection class="">
        ...
        <p>Another impressive site is Dr. Leo Niehorster's <a href="http://niehorster.org/">World War II Armed Forces —
          Orders of Battle and Organizations</a>. The site is a gold mine of information.</p>
