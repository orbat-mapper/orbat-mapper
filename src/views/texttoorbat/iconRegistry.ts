...
export const BUILTIN_ICON_DEFINITIONS: IconDefinition[] = [
  ...
  },
  {
    ...
    aliases: ["airborne", "abn", "parachute", "para", "paratrooper", "fallschirmjager"],
  },
  // RA (Royal Artillery) — must precede generic artillery
  {
    ...
    aliases: ["ra", "R.A.", "royal artillery"],
  },
  {
  ...
  },
  {
    ...
    aliases: ["mountain infantry", "mtn inf", "alpine", "gebirgsjager", "gebirgs"],
  },
  {
    name: "ICON_LIGHT_INFANTRY",
    sidc: "10001000001211000019",
    label: "Light Infantry",
    aliases: ["light infantry", "lt inf", "lti", "jager", "chasseur", "bersaglieri"],
  },
  {
