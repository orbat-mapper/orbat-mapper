  ...
  <div :class="props.class">
    ...
    <div class="mt-1">
      <input
        ...
        v-model="inputValue"
        :id="inputId"
        class="block w-full rounded-md border-0 bg-white py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 invalid:border-pink-500 invalid:text-pink-600 focus:ring-2 focus:ring-inset focus:ring-indigo-600 focus:invalid:border-pink-500 focus:invalid:ring-pink-500 disabled:border-slate-200 disabled:bg-slate-50 disabled:text-slate-500 disabled:shadow-none dark:bg-gray-800 dark:text-gray-200 sm:text-sm sm:leading-6"
        v-bind="$attrs"
      />
    </div>
