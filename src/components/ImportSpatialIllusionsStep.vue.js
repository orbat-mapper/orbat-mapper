...
var useFillColor = (0, vue_1.ref)(true);
var expandedStackedUnits = (0, vue_1.ref)(true);
...
var computedColumns = (0, vue_1.computed)(function () {
    return [
        {
            accessorFn: function (f) { return f.options.uniqueDesignation; },
            id: "name",
            header: "Unit",
        ...
        },
        {
            ...
            accessorFn: function (f) { return f.options.additionalInformation; },
            enableSorting: false,
        },
        {
            id: "stack",
            header: "Stack",
            accessorFn: function (f) { return f.options.stack; },
            enableSorting: false,
        },
        {
            id: "fillColor",
            header: "Fill color",
            accessorFn: function (f) { return f.options.fillColor; },
            enableSorting: false,
        },
        {
            id: "reinforced",
            header: "Reinforced",
            accessorFn: function (f) { return f.options.reinforced; },
            enableSorting: false,
        },
    ];
});
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            scnStore.groupUpdate(function () {
                function helper(u, parentId) {
                    var _a;
                    var _b = u.options, _c = _b.uniqueDesignation, name = _c === void 0 ? "" : _c, sidc = _b.sidc;
                    var stack = expandedStackedUnits.value ? u.options.stack || 1 : 1;
                    var fillColor = useFillColor.value ? u.options.fillColor : undefined;
                    var newUnit = {
                        name: name,
                    ...
                    if (u.options.reinforced) {
                        newUnit.reinforcedStatus = (0, externalModels_1.mapSpatialIllusionsReinforced)(u.options.reinforced);
                    }
                    if (u.options.additionalInformation) {
                        newUnit.textAmplifiers.additionalInformation = u.options.additionalInformation;
                    }
                    var _loop_1 = function (i) {
                        var newUnitId = unitActions.addUnit(newUnit, parentId);
                        (_a = u.subOrganizations) === null || _a === void 0 ? void 0 : _a.forEach(function (subUnit) { return helper(subUnit, newUnitId); });
                    };
...
}
{
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.section, __VLS_intrinsics.section)(__assign({ class: "space-y-3" }));
    /** @type {__VLS_StyleScopedClasses['space-y-3']} */ ;
    var __VLS_30 = InputCheckbox_vue_1.default;
    // @ts-ignore
    var __VLS_31 = __VLS_asFunctionalComponent1(__VLS_30, new __VLS_30({
        modelValue: (__VLS_ctx.useFillColor),
    ...
    var __VLS_36 = __VLS_asFunctionalComponent1(__VLS_35, new __VLS_35({
        modelValue: (__VLS_ctx.expandedStackedUnits),
    ...
    // @ts-ignore
    [rootUnitItems, groupedRootUnitItems, parentUnitId, useFillColor, expandedStackedUnits,];
}
...
var __VLS_40 = DataGrid_vue_1.default;
// @ts-ignore
var __VLS_41 = __VLS_asFunctionalComponent1(__VLS_40, new __VLS_40(__assign(__assign({ data: ([props.data]), columns: (__VLS_ctx.computedColumns), rowHeight: (40) }, { class: "flex-1" }), { initialState: ({ expanded: true }), getSubRows: (function (row) { return row.subOrganizations; }) })));
var __VLS_42 = __VLS_41.apply(void 0, __spreadArray([__assign(__assign({ data: ([props.data]), columns: (__VLS_ctx.computedColumns), rowHeight: (40) }, { class: "flex-1" }), { initialState: ({ expanded: true }), getSubRows: (function (row) { return row.subOrganizations; }) })], __VLS_functionalComponentArgsRest(__VLS_41), false));
/** @type {__VLS_StyleScopedClasses['flex-1']} */ ;
// @ts-ignore
[computedColumns,];
var __VLS_3;
