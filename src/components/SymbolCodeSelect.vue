...
<template>
  <Listbox as="div" v-model="selectedValue" class="">
    ...
    <div class="mt-1 relative">
      ...
      >
        <ListboxOptions
          class="absolute z-10 mt-1 w-full bg-white shadow-lg max-h-56 border border-gray-200 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm"
        >
          <ListboxOption
            as="template"
            v-for="item in items"
          ...
          >
            ...
            >
              <div class="flex items-start">
                <p class="flex-shrink-0 h-7 w-8 flex justify-center">
