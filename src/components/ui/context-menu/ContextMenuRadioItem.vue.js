...
reka_ui_1.ContextMenuRadioItem;
// @ts-ignore
...
var __VLS_7;
/** @ts-ignore @type {typeof __VLS_components.ContextMenuItemIndicator | typeof __VLS_components.ContextMenuItemIndicator} */
reka_ui_1.ContextMenuItemIndicator;
// @ts-ignore
...
// @ts-ignore
var __VLS_16 = __VLS_asFunctionalComponent1(__VLS_15, new __VLS_15(__assign({ class: "size-2 fill-current" })));
var __VLS_17 = __VLS_16.apply(void 0, __spreadArray([__assign({ class: "size-2 fill-current" })], __VLS_functionalComponentArgsRest(__VLS_16), false));
