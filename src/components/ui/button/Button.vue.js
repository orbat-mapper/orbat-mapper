...
reka_ui_1.Primitive;
// @ts-ignore
var __VLS_1 = __VLS_asFunctionalComponent1(__VLS_0, new __VLS_0(__assign({ dataSlot: "button", as: (__VLS_ctx.as), asChild: (__VLS_ctx.asChild) }, { class: (__VLS_ctx.cn(__VLS_ctx.buttonVariants({ variant: __VLS_ctx.variant, size: __VLS_ctx.size }), props.class)) })));
