...
reka_ui_1.NumberFieldRoot;
// @ts-ignore
var __VLS_1 = __VLS_asFunctionalComponent1(__VLS_0, new __VLS_0(__assign(__assign({}, (__VLS_ctx.forwarded)), { class: (__VLS_ctx.cn('grid gap-1.5', props.class)) })));
var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign(__assign({}, (__VLS_ctx.forwarded)), { class: (__VLS_ctx.cn('grid gap-1.5', props.class)) })], __VLS_functionalComponentArgsRest(__VLS_1), false));
var __VLS_5 = {};
{
