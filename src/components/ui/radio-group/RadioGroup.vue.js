...
// @ts-ignore
var __VLS_1 = __VLS_asFunctionalComponent1(__VLS_0, new __VLS_0(__assign(__assign({ dataSlot: "radio-group" }, { class: (__VLS_ctx.cn('grid gap-3', props.class)) }), (__VLS_ctx.forwarded))));
var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign(__assign({ dataSlot: "radio-group" }, { class: (__VLS_ctx.cn('grid gap-3', props.class)) }), (__VLS_ctx.forwarded))], __VLS_functionalComponentArgsRest(__VLS_1), false));
var __VLS_5 = {};
{
