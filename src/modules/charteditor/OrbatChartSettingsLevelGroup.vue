<template>
  <div class="space-y-4 pb-4">
    ...
    <div v-if="currentLevelGroup !== null" class="space-y-6">
      <header class="flex items-start">{{ currentLevelGroup }}</header>
...
export default defineComponent({
  ...
  setup() {
    ...
    const elementOptions = computed(() => {
      return (
        currentLevelGroup.value !== null &&
        specificOptions.levelGroup[currentLevelGroup.value]
      );
    });
    ...
    function setValue(name: string, value: any) {
      ...
      if (currentLevelGroup.value !== null)
        specificOptions.levelGroup[currentLevelGroup.value] = opts;
    }
