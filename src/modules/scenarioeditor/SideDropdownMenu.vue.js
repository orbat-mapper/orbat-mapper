...
var sideMenuItems = (0, vue_1.computed)(function () {
    return [
        { label: "Edit", action: constants_1.SideActions.Edit, disabled: props.isLocked },
        ...
        props.isLocked
            ? { label: "Unlock side", action: constants_1.SideActions.Unlock }
            : { label: "Lock side", action: constants_1.SideActions.Lock },
        props.isHidden
            ? { label: "Show side", action: constants_1.SideActions.Show }
            : { label: "Hide side", action: constants_1.SideActions.Hide },
        { separator: true },
        { label: "Add side", action: constants_1.SideActions.Add, disabled: props.isLocked },
        { label: "Add group", action: constants_1.SideActions.AddGroup, disabled: props.isLocked },
        {
            label: "Add root unit",
        ...
        { separator: true },
        { label: "Delete side", action: constants_1.SideActions.Delete, disabled: props.isLocked },
    ];
});
...
var _loop_1 = function (item, index) {
    ('action' in item ? item.action : index);
    if ('separator' in item) {
        ...
        // @ts-ignore
        var __VLS_47 = __VLS_asFunctionalComponent1(__VLS_46, new __VLS_46(__assign({ 'onSelect': {} }, { disabled: (item.disabled) })));
        var __VLS_48 = __VLS_47.apply(void 0, __spreadArray([__assign({ 'onSelect': {} }, { disabled: (item.disabled) })], __VLS_functionalComponentArgsRest(__VLS_47), false));
        var __VLS_51 = void 0;
        var __VLS_52 = ({ select: {} },
            { onSelect: function () {
                    var _a = [];
...
var __VLS_49, __VLS_50;
for (var _i = 0, _a = __VLS_vFor((__VLS_ctx.sideMenuItems)); _i < _a.length; _i++) {
