...
var usedItems = (0, vue_1.computed)(function () { var _a; return ((_a = props.usedSupplies) !== null && _a !== void 0 ? _a : []).map(function (i) { return i.id; }); });
var _a = store.state, supplyClassMap = _a.supplyClassMap, supplyUomMap = _a.supplyUomMap;
var supplyCategories = (0, vue_1.computed)(function () {
    var sc = Object.values(store.state.supplyCategoryMap)
        .filter(function (v) { return !usedItems.value.includes(v.id); })
        .map(function (sc) {
        var _a, _b, _c, _d, _e, _f;
        var supplyClass = (_c = (_b = supplyClassMap[(_a = sc === null || sc === void 0 ? void 0 : sc.supplyClass) !== null && _a !== void 0 ? _a : ""]) === null || _b === void 0 ? void 0 : _b.name) !== null && _c !== void 0 ? _c : "";
        var uomObj = supplyUomMap[(_d = sc === null || sc === void 0 ? void 0 : sc.uom) !== null && _d !== void 0 ? _d : ""];
        var uom = (_f = (_e = uomObj === null || uomObj === void 0 ? void 0 : uomObj.code) !== null && _e !== void 0 ? _e : uomObj === null || uomObj === void 0 ? void 0 : uomObj.name) !== null && _f !== void 0 ? _f : "";
        return {
            label: "".concat(sc.name),
            value: sc.id,
        };
    });
    return (0, utils_1.sortBy)(sc, "label");
});
var _b = (0, forms_1.useForm)({
    id: "",
    count: 1,
}, modelValue), form = _b.form, handleSubmit = _b.handleSubmit;
function onSubmit() {
    handleSubmit();
    emit("submit", (0, klona_1.klona)(form.value));
}
(0, vue_1.watch)(supplyCategories, function () {
...
(__VLS_ctx.heading);
if (__VLS_ctx.supplyCategories.length) {
    ...
    var __VLS_1 = __VLS_asFunctionalComponent1(__VLS_0, new __VLS_0({
        ...
        items: (__VLS_ctx.supplyCategories),
    }));
...
var __VLS_16 = ({ cancel: {} },
    { onCancel: function () {
            ...
            __VLS_ctx.emit('cancel');
            // @ts-ignore
            [emit, heading, supplyCategories, supplyCategories, form, form,];
        } });
var __VLS_13;
var __VLS_14;
// @ts-ignore
