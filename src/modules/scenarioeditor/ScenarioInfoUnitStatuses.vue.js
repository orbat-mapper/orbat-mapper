...
var statuses = (0, vue_1.computed)(function () {
...
var form = (0, vue_1.ref)({ name: "", description: "" });
...
function onAddSubmit() {
    ...
    if (statuses.value.find(function (e) { return e.name === addForm.value.name; })) {
        send({
            type: "error",
    ...
    scn.unitActions.addUnitStatus(__assign({}, addForm.value));
...
function onItemAction(item, action) {
    switch (action) {
        case "edit":
            ...
            break;
        case "delete":
            var success = scn.unitActions.deleteUnitStatus(item.id);
            if (!success) {
                send({
                    type: "error",
...
var __VLS_1 = __VLS_asFunctionalComponent1(__VLS_0, new __VLS_0({
    description: "A list of unit statues is available in this scenario.",
}));
...
var __VLS_12 = ({ click: {} },
    { onClick: function () {
            ...
            var $event = _a[0];
            __VLS_ctx.store.toggleAddEquipment();
            // @ts-ignore
            [store,];
        } });
var __VLS_13 = __VLS_9.slots.default;
(__VLS_ctx.store.showAddEquipment ? "Hide form" : "Add");
// @ts-ignore
[store,];
var __VLS_9;
var __VLS_10;
...
[];
var __VLS_3;
if (__VLS_ctx.store.showAddEquipment) {
    ...
    var __VLS_19 = InputGroup_vue_1.default;
    // @ts-ignore
    var __VLS_20 = __VLS_asFunctionalComponent1(__VLS_19, new __VLS_19(__assign({ class: "" }, { label: "Description", modelValue: (__VLS_ctx.addForm.description) })));
    var __VLS_21 = __VLS_20.apply(void 0, __spreadArray([__assign({ class: "" }, { label: "Description", modelValue: (__VLS_ctx.addForm.description) })], __VLS_functionalComponentArgsRest(__VLS_20), false));
    /** @type {__VLS_StyleScopedClasses['']} */ ;
    var __VLS_24 = BaseButton_vue_1.default || BaseButton_vue_1.default;
    // @ts-ignore
    var __VLS_25 = __VLS_asFunctionalComponent1(__VLS_24, new __VLS_24(__assign({ type: "submit", small: true, primary: true }, { class: "self-center" })));
    var __VLS_26 = __VLS_25.apply(void 0, __spreadArray([__assign({ type: "submit", small: true, primary: true }, { class: "self-center" })], __VLS_functionalComponentArgsRest(__VLS_25), false));
    /** @type {__VLS_StyleScopedClasses['self-center']} */ ;
    var __VLS_29 = __VLS_27.slots.default;
    // @ts-ignore
    [store, onAddSubmit, addForm, addForm,];
    var __VLS_27;
}
...
var _loop_1 = function (status_1) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.tr, __VLS_intrinsics.tr)(__assign({ onDblclick: function () {
            var _a = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                _a[_i] = arguments[_i];
            }
            var $event = _a[0];
            __VLS_ctx.startEdit(status_1);
            // @ts-ignore
            [onSubmit, statuses, startEdit,];
        } }, { key: (status_1.id) }));
    if (status_1.id === __VLS_ctx.editedId) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.td, __VLS_intrinsics.td)({});
        ...
        /** @type {__VLS_StyleScopedClasses['flex']} */ ;
        __VLS_asFunctionalElement1(__VLS_intrinsics.input)(__assign(__assign({ type: "text", value: (__VLS_ctx.form.description) }, { class: "flex-auto text-sm" }), { placeholder: "Description" }));
        /** @type {__VLS_StyleScopedClasses['flex-auto']} */ ;
        /** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
        var __VLS_30 = BaseButton_vue_1.default || BaseButton_vue_1.default;
        // @ts-ignore
        var __VLS_31 = __VLS_asFunctionalComponent1(__VLS_30, new __VLS_30(__assign({ small: true, type: "submit", secondary: true }, { class: "ml-2" })));
        var __VLS_32 = __VLS_31.apply(void 0, __spreadArray([__assign({ small: true, type: "submit", secondary: true }, { class: "ml-2" })], __VLS_functionalComponentArgsRest(__VLS_31), false));
        /** @type {__VLS_StyleScopedClasses['ml-2']} */ ;
        var __VLS_35 = __VLS_33.slots.default;
        // @ts-ignore
        [editedId, form, form,];
        var __VLS_36 = BaseButton_vue_1.default || BaseButton_vue_1.default;
        // @ts-ignore
        var __VLS_37 = __VLS_asFunctionalComponent1(__VLS_36, new __VLS_36(__assign(__assign({ 'onClick': {} }, { small: true }), { class: "ml-2" })));
        var __VLS_38 = __VLS_37.apply(void 0, __spreadArray([__assign(__assign({ 'onClick': {} }, { small: true }), { class: "ml-2" })], __VLS_functionalComponentArgsRest(__VLS_37), false));
        var __VLS_41 = void 0;
        var __VLS_42 = ({ click: {} },
            { onClick: function () {
                    var _a = [];
        ...
        var __VLS_44 = DotsMenu_vue_1.default;
        // @ts-ignore
        var __VLS_45 = __VLS_asFunctionalComponent1(__VLS_44, new __VLS_44(__assign({ 'onAction': {} }, { items: (__VLS_ctx.itemActions) })));
        var __VLS_46 = __VLS_45.apply(void 0, __spreadArray([__assign({ 'onAction': {} }, { items: (__VLS_ctx.itemActions) })], __VLS_functionalComponentArgsRest(__VLS_45), false));
        var __VLS_49 = void 0;
        var __VLS_50 = ({ action: {} },
            { onAction: function () {
                    var _a = [];
                    ...
                    if (!!(status_1.id === __VLS_ctx.editedId))
                        return;
                    __VLS_ctx.onItemAction(status_1, $event);
                    // @ts-ignore
...
var __VLS_33, __VLS_39, __VLS_40, __VLS_47, __VLS_48;
for (var _i = 0, _a = __VLS_vFor((__VLS_ctx.statuses)); _i < _a.length; _i++) {
