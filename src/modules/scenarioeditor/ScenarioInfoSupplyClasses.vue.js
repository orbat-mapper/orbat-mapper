...
var tableStore = (0, tableStores_1.useSupplyClassTableStore)();
...
function onAddSubmit(formData) {
    ...
    if (supplyClasses.value.find(function (e) { return e.name === formData.name; })) {
        send({
            type: "error",
    ...
    scn.unitActions.addSupplyClass(__assign({}, formData));
...
function onDelete() {
    ...
    scn.store.groupUpdate(function () {
        selectedItems.value.forEach(function (e) {
            var success = scn.unitActions.deleteSupplyClass(e.id);
            if (!success) {
                send({
                    type: "error",
...
var __VLS_1 = __VLS_asFunctionalComponent1(__VLS_0, new __VLS_0({
    description: "A list of supply classes available in this scenario.",
}));
...
// @ts-ignore
var __VLS_6 = __VLS_asFunctionalComponent1(__VLS_5, new __VLS_5(__assign({ 'onDelete': {} }, { editMode: (__VLS_ctx.editMode), addMode: (__VLS_ctx.showAddForm), editLabel: "Edit supply classes", selectedCount: (__VLS_ctx.selectedItems.length), hideEdit: (__VLS_ctx.supplyClasses.length === 0) })));
var __VLS_7 = __VLS_6.apply(void 0, __spreadArray([__assign({ 'onDelete': {} }, { editMode: (__VLS_ctx.editMode), addMode: (__VLS_ctx.showAddForm), editLabel: "Edit supply classes", selectedCount: (__VLS_ctx.selectedItems.length), hideEdit: (__VLS_ctx.supplyClasses.length === 0) })], __VLS_functionalComponentArgsRest(__VLS_6), false));
var __VLS_10;
var __VLS_11 = ({ delete: {} },
    { onDelete: function () {
            var _a = [];
            ...
            __VLS_ctx.onDelete();
            // @ts-ignore
            [editMode, showAddForm, selectedItems, supplyClasses, onDelete,];
        } });
var __VLS_8;
var __VLS_9;
...
if (__VLS_ctx.supplyClasses.length) {
    ...
    var __VLS_25 = __VLS_23.slots.default;
    {
        ...
        // @ts-ignore
        var __VLS_34 = __VLS_asFunctionalComponent1(__VLS_33, new __VLS_33(__assign(__assign({ 'onSubmit': {} }, { 'onCancel': {} }), { modelValue: (row), heading: "Edit supply class" })));
        var __VLS_35 = __VLS_34.apply(void 0, __spreadArray([__assign(__assign({ 'onSubmit': {} }, { 'onCancel': {} }), { modelValue: (row), heading: "Edit supply class" })], __VLS_functionalComponentArgsRest(__VLS_34), false));
        var __VLS_38 = void 0;
        var __VLS_39 = ({ submit: {} },
            { onSubmit: function () {
                    var _a = [];
                    ...
                    // @ts-ignore
                    [editMode, editMode, selectedItems, supplyClasses, supplyClasses, onAddSubmit, columns, editedId, tableStore, onSubmit,];
                } });
        var __VLS_40 = ({ cancel: {} },
            { onCancel: function () {
                    var _a = [];
