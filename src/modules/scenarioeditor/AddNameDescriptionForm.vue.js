...
// @ts-ignore
var __VLS_6 = __VLS_asFunctionalComponent1(__VLS_5, new __VLS_5(__assign({ class: "" }, { label: "Description", modelValue: (__VLS_ctx.form.description) })));
var __VLS_7 = __VLS_6.apply(void 0, __spreadArray([__assign({ class: "" }, { label: "Description", modelValue: (__VLS_ctx.form.description) })], __VLS_functionalComponentArgsRest(__VLS_6), false));
/** @type {__VLS_StyleScopedClasses['']} */ ;
var __VLS_10 = FormFooter_vue_1.default;
// @ts-ignore
var __VLS_11 = __VLS_asFunctionalComponent1(__VLS_10, new __VLS_10(__assign({ 'onCancel': {} }, { showNextToggle: (__VLS_ctx.showNextToggle) })));
var __VLS_12 = __VLS_11.apply(void 0, __spreadArray([__assign({ 'onCancel': {} }, { showNextToggle: (__VLS_ctx.showNextToggle) })], __VLS_functionalComponentArgsRest(__VLS_11), false));
var __VLS_15;
var __VLS_16 = ({ cancel: {} },
    { onCancel: function () {
            var _a = [];
            ...
            __VLS_ctx.emit('cancel');
            // @ts-ignore
            [onSubmit, onSubmit, emit, heading, form, form, showNextToggle,];
        } });
var __VLS_13;
var __VLS_14;
// @ts-ignore
