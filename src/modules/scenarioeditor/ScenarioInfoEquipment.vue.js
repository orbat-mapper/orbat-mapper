...
var tableStore = (0, tableStores_1.useEquipmentTableStore)();
var uiStore = (0, uiStore_1.useUiStore)();
var equipment = (0, vue_1.computed)(function () {
...
function onSubmit(e) {
    ...
    if (uiStore.goToNextOnSubmit) {
        var currentIndex = equipment.value.findIndex(function (sc) { return sc.id === id; });
...
function onAddSubmit(formData) {
    ...
    if (equipment.value.find(function (e) { return e.name === formData.name; })) {
        send({
            type: "error",
    ...
    scn.unitActions.addEquipment(__assign({}, formData));
...
function onDelete() {
    ...
    scn.store.groupUpdate(function () {
        selectedItems.value.forEach(function (e) {
            var success = scn.unitActions.deleteEquipment(e.id);
            if (!success) {
                send({
                    type: "error",
...
// @ts-ignore
var __VLS_6 = __VLS_asFunctionalComponent1(__VLS_5, new __VLS_5(__assign({ 'onDelete': {} }, { editMode: (__VLS_ctx.editMode), addMode: (__VLS_ctx.showAddForm), editLabel: "Edit equipment", selectedCount: (__VLS_ctx.selectedItems.length), hideEdit: (__VLS_ctx.equipment.length === 0) })));
var __VLS_7 = __VLS_6.apply(void 0, __spreadArray([__assign({ 'onDelete': {} }, { editMode: (__VLS_ctx.editMode), addMode: (__VLS_ctx.showAddForm), editLabel: "Edit equipment", selectedCount: (__VLS_ctx.selectedItems.length), hideEdit: (__VLS_ctx.equipment.length === 0) })], __VLS_functionalComponentArgsRest(__VLS_6), false));
var __VLS_10;
var __VLS_11 = ({ delete: {} },
    { onDelete: function () {
            var _a = [];
            ...
            __VLS_ctx.onDelete();
            // @ts-ignore
            [editMode, showAddForm, selectedItems, equipment, onDelete,];
        } });
var __VLS_8;
var __VLS_9;
...
if (__VLS_ctx.equipment.length) {
    ...
    var __VLS_25 = __VLS_23.slots.default;
    {
        ...
        // @ts-ignore
        var __VLS_34 = __VLS_asFunctionalComponent1(__VLS_33, new __VLS_33(__assign(__assign({ 'onSubmit': {} }, { 'onCancel': {} }), { modelValue: (row), heading: "Edit equipment category", showNextToggle: true })));
        var __VLS_35 = __VLS_34.apply(void 0, __spreadArray([__assign(__assign({ 'onSubmit': {} }, { 'onCancel': {} }), { modelValue: (row), heading: "Edit equipment category", showNextToggle: true })], __VLS_functionalComponentArgsRest(__VLS_34), false));
        var __VLS_38 = void 0;
        var __VLS_39 = ({ submit: {} },
            { onSubmit: function () {
                    var _a = [];
                    ...
                    // @ts-ignore
                    [editMode, editMode, selectedItems, equipment, equipment, onAddSubmit, columns, editedId, tableStore, onSubmit,];
                } });
        var __VLS_40 = ({ cancel: {} },
            { onCancel: function () {
                    var _a = [];
