...
var AddSupplyUoMForm_vue_1 = require("@/modules/scenarioeditor/AddSupplyUoMForm.vue");
...
var tableStore = (0, tableStores_1.useSupplyUoMTableStore)();
...
function onAddSubmit(formData) {
    ...
    if (supplyUnits.value.find(function (e) { return e.name === formData.name; })) {
        send({
            type: "error",
    ...
    scn.unitActions.addSupplyUom(__assign({}, formData));
    addForm.value = __assign(__assign({}, addForm.value), { name: "", code: "", description: "" });
}
function onDelete() {
    var notDeletedItems = [];
    scn.store.groupUpdate(function () {
        selectedItems.value.forEach(function (e) {
            var success = scn.unitActions.deleteSupplyUom(e.id);
            if (!success) {
                send({
                    type: "error",
                    message: "".concat(e.name, ": Cannot delete an item that is in use."),
                });
...
// @ts-ignore
var __VLS_6 = __VLS_asFunctionalComponent1(__VLS_5, new __VLS_5(__assign({ 'onDelete': {} }, { editMode: (__VLS_ctx.editMode), addMode: (__VLS_ctx.showAddForm), editLabel: "Edit UoM/UI", selectedCount: (__VLS_ctx.selectedItems.length), hideEdit: (__VLS_ctx.supplyUnits.length === 0) })));
var __VLS_7 = __VLS_6.apply(void 0, __spreadArray([__assign({ 'onDelete': {} }, { editMode: (__VLS_ctx.editMode), addMode: (__VLS_ctx.showAddForm), editLabel: "Edit UoM/UI", selectedCount: (__VLS_ctx.selectedItems.length), hideEdit: (__VLS_ctx.supplyUnits.length === 0) })], __VLS_functionalComponentArgsRest(__VLS_6), false));
var __VLS_10;
var __VLS_11 = ({ delete: {} },
    { onDelete: function () {
            var _a = [];
            ...
            __VLS_ctx.onDelete();
            // @ts-ignore
            [editMode, showAddForm, selectedItems, supplyUnits, onDelete,];
        } });
var __VLS_8;
var __VLS_9;
if (__VLS_ctx.showAddForm) {
    var __VLS_12 = AddSupplyUoMForm_vue_1.default;
    // @ts-ignore
    var __VLS_13 = __VLS_asFunctionalComponent1(__VLS_12, new __VLS_12(__assign(__assign({ 'onCancel': {} }, { 'onSubmit': {} }), { modelValue: (__VLS_ctx.addForm), heading: "Add new unit of measure/issue" })));
    var __VLS_14 = __VLS_13.apply(void 0, __spreadArray([__assign(__assign({ 'onCancel': {} }, { 'onSubmit': {} }), { modelValue: (__VLS_ctx.addForm), heading: "Add new unit of measure/issue" })], __VLS_functionalComponentArgsRest(__VLS_13), false));
    var __VLS_17 = void 0;
    var __VLS_18 = ({ cancel: {} },
        { onCancel: function () {
                var _a = [];
...
if (__VLS_ctx.supplyUnits.length) {
    ...
    var __VLS_25 = __VLS_23.slots.default;
    {
        ...
        var __VLS_33 = AddSupplyUoMForm_vue_1.default;
        // @ts-ignore
        var __VLS_34 = __VLS_asFunctionalComponent1(__VLS_33, new __VLS_33(__assign(__assign({ 'onSubmit': {} }, { 'onCancel': {} }), { modelValue: (row), heading: "Edit unit of measure/issue" })));
        var __VLS_35 = __VLS_34.apply(void 0, __spreadArray([__assign(__assign({ 'onSubmit': {} }, { 'onCancel': {} }), { modelValue: (row), heading: "Edit unit of measure/issue" })], __VLS_functionalComponentArgsRest(__VLS_34), false));
        var __VLS_38 = void 0;
        var __VLS_39 = ({ submit: {} },
            { onSubmit: function () {
                    var _a = [];
                    ...
                    // @ts-ignore
                    [editMode, editMode, selectedItems, supplyUnits, supplyUnits, onAddSubmit, columns, editedId, tableStore, onSubmit,];
                } });
        var __VLS_40 = ({ cancel: {} },
            { onCancel: function () {
                    var _a = [];
